...
<body>
  <c:set var="pageUrl" scope="request">
	 <c:url value="/content/role/delete" />
  </c:set>
	 ...
	 <table class="tblHeader-inner">																																						
		<tr>
			<td colspan="2" align="left"><font size="3"><b>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Delete Role</b></font><br />
			</td>
		</tr>
		<c:if test='${not empty roledeleted}'> 
			<tr>
					<td align="center"><br />
						<font color="green" size="3"><b>${roledeleted}</b></font>
				</td>
			</tr>
		</c:if>
	</table><br />	
	...
	<table id="tblDeleteTeam" class="table table-striped table-bordered table-condensed table-hover">
		<tbody>
			<!-- <tr>
				...
				<c:if test="${not empty role_list}">
					<c:forEach items="${role_list}" var="item">
						<tr>
							<td>
								<spring:bind path="id">
									&nbsp;&nbsp;&nbsp;<form:input id="deleteId" required="true" name="deleteName" path="id" type="radio" value="${item.id}" ></form:input>&nbsp;&nbsp;&nbsp;
								</spring:bind>
							</td>
				...
				<tr>
					<td><font color=blue>---------*No Roles Available to Delete*---------</font></td>
