...
<c:set var="pageUrl" scope="request">
	 <c:url value="/content/userrole/saveteamrole" />
  </c:set>
	<form:form id="signup" class="form-createuser" commandName="crudObj" action="${pageUrl}" method="POST">
		<table class="tblHeader-inner">
			<tr>
				<td colspan="2" align="center"><font size="3"><b>Assign Roles To Team</b></font><br /><br />
				</td>
			</tr>
		...
		<table id="tblCreateProject" class="tblFormData">
				...
				<td style="text-align:right;padding-right:18px;">
					<form:label for="teamList" path="">Select A Team<br /><font color="green" size="2"></font></form:label>
				</td>
				<td>
					<form:select  id="idTeam" path="teamId" required="true"  style="color:#333333" onchange="getAssignedRolesToTeam('teamrole');getAvailableRolesToTeam('teamrole')">
