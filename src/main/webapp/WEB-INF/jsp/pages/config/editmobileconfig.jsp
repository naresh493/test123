...
<body>
 	 <table class="tblHeader-inner">																																						
		<tr>
			<td colspan="2" align="center"><font size="3"><b>Edit Mobile Configuration</b></font><br />
			</td>
		</tr>
	...
	<table id="editobjspyconfig" class="table table-striped table-bordered table-condensed table-hover">
		...
		<tbody>
			<c:if test="${not empty mobileconfig_list}">
				<c:forEach items="${mobileconfig_list}" var="item">
					<tr>
						<td colspan="1"><a href="mobile/${item.id}/updatemobileconfig">${item.configurationname}</a><br/>
	...
	<c:if test="${fn:length(mobileconfig_list)>10}">
