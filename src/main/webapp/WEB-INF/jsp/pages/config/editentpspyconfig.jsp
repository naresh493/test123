...
<body>
 	 <table class="tblHeader-inner">																																						
		<tr>
			<td colspan="2" align="center"><font size="3"><b>Edit Enterprise Configuration</b></font><br />
			</td>
		</tr>
	...
	<table id="editobjspyconfig" class="table table-striped table-bordered table-condensed table-hover">
		...
		<tbody>
			<c:if test="${not empty entpspy_list}">
				<c:forEach items="${entpspy_list}" var="item">
					<tr>
						<td colspan="1"><a href="entpspy/${item.id}/updateentpspy">${item.configurationname}</a><br/>
	...
	<c:if test="${fn:length(entpspy_list)>10}">
