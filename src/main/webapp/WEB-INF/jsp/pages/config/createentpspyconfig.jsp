...
<c:set var="pageUrl" scope="request">
	 <c:url value="/content/configuration/saveentpspy" />
  </c:set>
  <script type="text/javascript">
	...
	<form:form id="signup" class="form-createuser" action="${pageUrl}" commandName="crudObj" method="POST">
		<table class="tblHeader-inner">
			<tr>
				<td colspan="2" align="center"><font size="3"><b>Enterprise Configuration</b></font><br /><br />
				</td>
			</tr>
		...
		<tr>
			...
			<spring:bind path="typeEntpc">
				<form:hidden path="typeEntpc" value="entp"/>
			</spring:bind>
