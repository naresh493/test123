...
<c:set var="pageUrl" scope="request">
	 <c:url value="/content/module/saveassignpermissionstomodule" />
  </c:set>
	<form:form id="signup" class="form-createuser" commandName="crudObj" action="${pageUrl}" method="POST">
		<table class="tblHeader-inner">
			<tr>
				<td colspan="2" align="center"><font size="3"><b>Assign Permissions To License</b></font><br /><br />
				</td>
			</tr>
		...
		<table id="tblCreateProject" class="tblFormData">
				...
				<td>
					<form:select  id="idModule" path="moduleId" required="true"  style="color:#333333" onchange="getAssignedPermissions('module');getAvailablePermissions('module')">
				...
				<table align="center">
					...
					<tr id="trPerm" >
						...
						<div><font size="2">Assigned Permissions</font></div>
        						<form:select id="to" for="permaId" path="permissionsId" multiple="multiple" style="width:255px;height:155px;" required="true">
									<form:options itemValue="id"/>
								</form:select>
   						 	</td>
   						 </tr>
