...
<c:set var="pageUrl" scope="request">
	 <c:url value="/content/userteam/assign" />
  </c:set>
	<form:form id="signup" class="form-createuser" commandName="crudObj" action="${pageUrl}" method="POST">
		<table class="tblHeader-inner">
			<tr>
				<td colspan="2" align="center"><font size="3"><b>Assign Users To Team</b></font><br /><br />
				</td>
			</tr>
		...
		<table id="tblCreateProject" class="tblFormData">
				...
				<td>
					<form:select  id="idTeam" path="teamId" required="true"  style="color:#333333" onchange="getAssignedTeamUsers('userteam');getAvailableTeamUsers('userteam')">
				...
				<table align="center">
					...
					<td >
							...
							<form:select id="from"  for="users" path="users" multiple="multiple" style="width:177px;height:155px;">
					...
					<tr id="trtAsUsers" >
						...
						<div><font size="2">Assigned Users</font></div>
        						<form:select id="to" for="userId" path="userId" multiple="multiple" style="width:177px;height:155px;">
									<form:options itemValue="id"/>
								</form:select>
   						 	</td>
   						 </tr>
