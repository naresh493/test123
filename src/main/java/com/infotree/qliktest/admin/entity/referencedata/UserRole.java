...
public class UserRole implements BaseQTAdminEntity, Serializable,AccessControlled{
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private UserRoleComp userRoleComp;
	 ...
	 */
	public UserRoleComp getUserRoleComp() {
		return userRoleComp;
	}
	 ...
	 */
	public void setUserRoleComp(UserRoleComp userRoleComp) {
