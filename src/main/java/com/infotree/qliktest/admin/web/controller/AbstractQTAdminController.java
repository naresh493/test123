...
public abstract class AbstractQTAdminController<T extends BaseQTAdminEntity> {

	private static final Logger LOG = LoggerFactory.getLogger(AbstractQTAdminController.class);
	
	protected AbstractQTAdminController() {
	}

	public abstract QTAdminService<T> getTService();
	 ...
	 */
	/*
	 * This method is to fetch all records from the selected table
	 */
	 ...
	 */
	/*
	 * This method is to create the new operation
	 */
	 ...
	 */
	/*
	 * This method is to update the particular item which was selected by the user
	 */
    ...
    public String delete(@PathVariable String id, Model model) {
    	...
    	if(!result.equalsIgnoreCase(QTAdminCommonConstants.SUCCESS)){
