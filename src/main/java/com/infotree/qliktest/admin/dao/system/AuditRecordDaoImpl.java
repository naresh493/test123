...
public class AuditRecordDaoImpl implements AuditRecordDao {
	 ...
	 */
	public AuditRecord findLastChange(Class<? extends BaseQTAdminEntity> entityClass, Serializable entityId, AuditType type, String propertyName) {
